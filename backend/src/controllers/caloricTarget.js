...
const getAllByUserId = catchAsync(async (req, res, next) => {
    const caloricTargets = await caloricTargetService.getAllByUserId(req.userId);
    next(
...
const deleteByIdAndUserId = catchAsync(async (req, res, next) => {
    await caloricTargetService.deleteByIdAndUserId(req.params.caloricTargetId, req.userId);
